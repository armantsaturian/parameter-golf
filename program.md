...
3. Edit `train_gpt.py`.
4. git commit (so you can revert cleanly), then `git push origin HEAD` to back up to GitHub. **Always push after every commit** — if the instance dies, unpushed work is lost.
